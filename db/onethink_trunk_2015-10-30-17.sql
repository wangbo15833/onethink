...
INSERT INTO `onethink_demo` (`id`, `title`, `description`, `content`, `create_time`, `uid`, `status`) VALUES
(1, '名称', '描述', '详情', 1446197327, 1, 0);
...
(1, 'admin', 0, '0000-00-00', '', 20, 4, 0, 1445657400, 2130706433, 1446195516, 1);
...
(1, 'admin', 'a9b4ad048c33807db124a359ddcaf534', '492948155@qq.com', '', 1445657400, 2130706433, 1446195516, 2130706433, 1445657400, 1);
