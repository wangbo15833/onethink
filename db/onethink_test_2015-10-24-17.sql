...
(1, 1, '', 'OneThink1.0正式版发布test', 2, '大家期待的OneThink正式版发布', 0, 0, 2, 2, 0, 0, 0, 1, 0, 0, 8, 0, 0, 0, 1387260660, 1387263112, 1);
...
(1, 'admin', 0, '0000-00-00', '', 10, 4, 0, 1445657400, 2130706433, 1445677208, 1);
