...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=5 ;
...
(2, 1, 1, 2130706433, 'member', 1, 'admin在2015-10-24 13:50登录了后台', 1, 1445665812),
(3, 1, 1, 2130706433, 'member', 1, 'admin在2015-10-24 17:00登录了后台', 1, 1445677208),
(4, 1, 1, 2130706433, 'member', 1, 'admin在2015-10-26 09:40登录了后台', 1, 1445823606);
...
CREATE TABLE IF NOT EXISTS `onethink_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='插件表' AUTO_INCREMENT=21 ;
...
(19, 'FriendLink', '友情链接', '友情链接', 1, 'null', 'Lynx', '0.1', 1445665912, 1),
(20, 'Message', '留言板', '留言板插件', 1, '{"reply":"1","title":"1","summary":"1","username":"1","phone":"1","addr":"0","email":"1","qq":"0","type":"0"}', 'nzing', '0.1', 1445666547, 1);
...
(1, 1, '', 'OneThink1.0正式版发布test', 2, '大家期待的OneThink正式版发布', 0, 0, 2, 2, 0, 0, 1, 1, 0, 0, 8, 0, 0, 0, 1387260660, 1445823627, 1);
...
--
-- 表的结构 `onethink_friend_link`
--

CREATE TABLE IF NOT EXISTS `onethink_friend_link` (
...
--
-- 转存表中的数据 `onethink_friend_link`
--

INSERT INTO `onethink_friend_link` (`id`, `title`, `url`) VALUES
...
(17, 'FriendLink', '友情链接', 1, 1445665906, 'FriendLink'),
(18, 'Message', '在线留言提交钩子', 1, 0, 'Message');
...
(1, 'admin', 0, '0000-00-00', '', 20, 5, 0, 1445657400, 2130706433, 1445823606, 1);
...
CREATE TABLE IF NOT EXISTS `onethink_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='留言板表' AUTO_INCREMENT=5 ;

--
-- 转存表中的数据 `onethink_message`
--

INSERT INTO `onethink_message` (`id`, `title`, `summary`, `username`, `email`, `qq`, `phone`, `addr`, `sort`, `type`, `status`, `create_time`, `reply_info`) VALUES
(4, 'aaaa', 'aaaaaaaa', 'aaaaaaaaaa', 'sadf@asdf.com', '', '4055950', '', 0, 1, 1, 1445667059, '');
...
(1, '/Uploads/Picture/2015-10-26/562d8488722c7.jpg', '', 'a873ae63619d6b2463168d073721952f', 'f572120b8fd3d71aaf15bd5c84afe562af7f566a', 1, 1445823624);
...
(1, 'admin', 'a9b4ad048c33807db124a359ddcaf534', '492948155@qq.com', '', 1445657400, 2130706433, 1445657417, 2130706433, 1445657400, 1);
